  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        setErrorMsg('Failed to sign up with Google: ' + error.message)
        ...
        <div className="bg-slate-900 rounded-2xl border border-slate-800 p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-xs mt-1">
              Join us to post jobs or apply for remote opportunities worldwide
            </p>
          </div>
          ...
          {successMsg && (
            <div className="mb-6 p-3 bg-emerald-950/50 border border-emerald-800 text-emerald-300 text-xs rounded-xl">
              {successMsg}
            </div>
          )}
